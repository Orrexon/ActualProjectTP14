...
WindowManager::WindowManager(std::string p_title, int width, int height)
{
	sf::ContextSettings settings;
	settings.antialiasingLevel = 0;
	m_postFocus = false;
	m_window = new sf::RenderWindow(sf::VideoMode(width, height), p_title, sf::Style::None, settings);
